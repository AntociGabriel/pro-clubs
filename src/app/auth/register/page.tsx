...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.ok) {
      ...
      setForm({ email: '', name: '', password: '', image: '', platform: '', country: '', eaId: '', positions: [], avatarFile: null });
    } else {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4" encType="multipart/form-data">
        ...
        <input name="eaId" type="text" placeholder="EA ID" value={form.eaId} onChange={handleChange} className="w-full border p-2 rounded" />
        <div>
